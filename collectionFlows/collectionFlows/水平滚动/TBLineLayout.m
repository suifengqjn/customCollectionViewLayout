...
static const CGFloat TBITEMWH = 100;

@implementation TBLineLayout
...
- (void)prepareLayout
{
    ...
    // 每个cell的尺寸
    self.
    self.itemSize = CGSizeMake(TBITEMWH, TBITEMWH);
    CGFloat inset = (self.collectionView.frame.size.width - TBITEMWH) * 0.5;
    self.sectionInset = UIEdgeInsetsMake(0, inset, 0, inset);
    // 设置水平滚动
    self.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    self.minimumLineSpacing = TBITEMWH * 0.7;
